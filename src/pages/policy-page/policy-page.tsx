    ...
    <>
      <Space>
        <Typography.TitleResponsive tag="h1" view="large">
          <div className={styles.gap_2xl}>Политика в отношении обработки персональных данных</div>
      ...
      <ol>
        <li className={styles.block}>
          <Space>
            ...
            <Typography.Text>
              <div className={styles.gap}>
                ...
                и меры по обеспечению безопасности персональных данных ООО «Альфа Фьюче Пипл» (далее – Оператор).
              </div>
            </Typography.Text>
          </Space>
          ...
          <Typography.Text>
            <Space>
              <List tag="ul" marker="•" className={styles.subblock}>
                <li>
                ...
                <li>
                  ...
                  ко всей информации, которую Оператор может получить о посетителях веб-сайта https://store.alfabank.ru.
                </li>
              </List>
            </Space>
          </Typography.Text>
            ...
            <Space>
              <List tag="ul" marker="•" className={styles.subblock}>
                ...
                <li>
                  ...
                  данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://store.alfabank.ru;
                </li>
                <li>
                ...
                <li>
                  ...
                  определяемому Пользователю веб-сайта https://store.alfabank.ru;
                </li>
                <li>Пользователь – любой посетитель веб-сайта https://store.alfabank.ru;</li>
                <li>
            ...
            <Space>
              <List tag="ul" marker="•" className={styles.subblock}>
                <li>
                  ...
                  материалам, содержащимся на веб-сайте https://store.alfabank.ru; уточнение деталей заказа.
                </li>
                <li>
                  ...
                  информационных сообщений, направив Оператору письмо на адрес электронной почты info@alfabankstore.ru с
            ...
            <Space>
              <List tag="ul" marker="•" className={styles.subblock}>
                <li>
                  ...
                  https://store.alfabank.ru. Заполняя соответствующие формы и/или отправляя свои персональные данные
            ...
            <Space>
              <List tag="ul" marker="•" className={styles.subblock}>
                ...
                <li>
                  ...
                  info@alfabankstore.ru с пометкой «Актуализация персональных данных».
                </li>
                <li>
                  ...
                  почты на электронный адрес Оператора info@alfabankstore.ru с пометкой «Отзыв согласия на обработку
                  персональных данных».
                </li>
              </List>
            </Space>
            ...
            <Space>
              <List tag="ul" marker="•" className={styles.subblock}>
                <li>
                  ...
                  персональных данных, обратившись к Оператору с помощью электронной почты info@alfabankstore.ru.{' '}
                </li>
                <li>
                ...
                <li>
                  ...
                  https://store.alfabank.ru/policy.
                </li>
              </List>
            </Space>
          </Typography.Text>
